...
function UserAndPoint(props) {
  const { users, totalUser } = props;
  ...
  return (
    <div className="">
      <div className='mb-3 '>
        ...
        <p>Danh sách thành viên cùng điểm số, level và một số thông tin khác, bạn đang có {totalUser} / tối đa {window.limitTotalUser} thành viên</p>
        <div className='p-3'>
          <div className='mb-3'>
            <MDBRow>
