  ...
  return (
    <div className=" ">
      <MDBRow className='mb-3'>
        ...
        <MDBCol size="md" md="8" >
          <input type="text" name={sName('title')} defaultValue={sValue('title')} onChange={handleChange} className="form-control" />
        </MDBCol>
      </MDBRow>
      <MDBRow className='mb-3'>
        <MDBCol size="md" md="4">
        ...
        <MDBCol size="md" md="8" className='d-flex align-items-center'>
          <input name={sName('titleColor')} defaultValue={sValue('titleColor')} onInput={handleChange} type="color" className="form-control form-control-color bg-dark border-0 px-0" />
      ...
      <MDBRow className='mb-3'>
        ...
        <MDBCol size="md" md="8" className='d-flex align-items-center'>
          <input name={sName('textColor')} defaultValue={sValue('textColor')} onInput={handleChange} type="color" className="form-control form-control-color bg-dark border-0 px-0" />
      ...
      <MDBRow className='mb-3'>
        ...
        <MDBCol size="md" md="8" className='d-flex align-items-center'>
          <input name={sName('barBgColor')} defaultValue={sValue('barBgColor')} onInput={handleChange} type="color" className="form-control form-control-color bg-dark border-0 px-0" />
      ...
      <MDBRow className='mb-3'>
        ...
        <MDBCol size="md" md="8" className='d-flex align-items-center'>
          <input name={sName('barColor')} defaultValue={sValue('barColor')} onInput={handleChange} type="color" className="form-control form-control-color bg-dark border-0 px-0" />
