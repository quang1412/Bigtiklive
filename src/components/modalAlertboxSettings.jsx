    ...
    <div className=" ">
      <MDBTabs fill className="mb-3">
        {["general", "like", "share", "follow", "gift"].map((type, index) => (
          <MDBTabsItem key={index} className=" ">
            ...
            >
              {type
                .replace("general", "chung")
                .replace("gift", "quà tặng")
                .replace("like", "lượt thích")
                .replace("share", "chia sẻ")
                .replace("follow", "theo dõi")
                .toUpperCase()}
            </MDBTabsLink>
          </MDBTabsItem>
        ))}
      ...
      <MDBTabsContent className="text-start pt-5">
          ...
          <form name="general">
            <div className="row mb-3">
              ...
              <div className="col-8">
                <div className="range">
                  <MDBRange
                    name="widget_alertbox_general_alertdelay"
                    defaultValue={settings.widget_alertbox_general_alertdelay}
            ...
            <div className="row mb-3">
              ...
              <div className="col-8">
                <div className="form-check d-inline-block">
                  <input
                    name="widget_alertbox_general_alertparries"
                    defaultValue="true"
                    onChange={handleChange}
            ...
            {settings.widget_alertbox_general_alertparries && (
              <div className="row mb-3 parry_alert_delay d-flex">
                ...
                <div className="col-8">
                  <div className="range">
                    <MDBRange
                      name="widget_alertbox_general_parryalertdelay"
                      defaultValue={
                        settings.widget_alertbox_general_parryalertdelay
                      }
                      onChange={handleChange}
                      type="range"
                      className="form-range"
        ...
        {["gift", "like", "share", "follow"].map((type, index) => {
          ...
          const sValue = (shortName) =>
            settings[`widget_alertbox_${type}_${shortName}`]
          const toggleShow = () => {
              ...
              <form name={type}>
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8 d-flex">
                    <select
                      name={sName("alertanimationin")}
                      defaultValue={sValue("alertanimationin")}
                      onChange={handleChange}
                    ...
                    <select
                      name={sName("alertanimationout")}
                      defaultValue={sValue("alertanimationout")}
                      onChange={handleChange}
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-8">
                      <div className="input-group w-50">
                        <input
                          name={sName("alertminamount")}
                          min="1"
                          type="number"
                          defaultValue={sValue("alertminamount")}
                          onChange={handleChange}
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8">
                    <div className="input-group">
                      <input
                        name={sName("messagetemplate")}
                        defaultValue={sValue("messagetemplate")}
                        onChange={handleChange}
                        type="text"
                        className="form-control "
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8 d-sm-flex align-items-center text-end">
                    <select
                      name={sName("textanimation")}
                      defaultValue={sValue("textanimation")}
                      onChange={handleChange}
                    ...
                    <div className="fw-bold text-nowrap text-info">
                      <span
                        className={`animated-letter ${sValue("textanimation")}`}
                      >
                        S
                      </span>
                      <span
                  ...
                  <div className="col-8">
                    <div className="input-group">
                      <span
                        ...
                        style={{
                          backgroundImage: `url(${sValue("imageurl")})`,
                    ...
                    <small className="text-muted">
                      tìm thêm ảnh động tại{" "}
                      <a href="https://giphy.com/reactions" target="_blank">
                        <u>Giphy.com</u>
                      </a>
                    </small>
                  </div>
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8">
                    ...
                    <small className="text-muted">
                      tìm thêm âm thanh tại{" "}
                      <a
                        href="https://www.myinstants.com/en/index/vn/"
                        target="_blank"
                      >
                        <u>Myinstants.com</u>
                      </a>
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8">
                    <div className="range">
                      <MDBRange
                        name={sName("soundvolume")}
                        defaultValue={sValue("soundvolume")}
                        onChange={handleChange}
                        type="range"
                        className="form-range"
                        min="0"
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8">
                    <div className="range">
                      <MDBRange
                        name={sName("alertduration")}
                        defaultValue={sValue("alertduration")}
                        onChange={handleChange}
                        type="range"
                        className="form-range"
                        min="2"
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-8">
                    <div className="range">
                      <MDBRange
                        name={sName("alerttextdelay")}
                        defaultValue={sValue("alerttextdelay")}
                        onChange={handleChange}
                        type="range"
                        className="form-range"
                        min="0"
                  ...
                  <MDBCollapse show={showShow[type]}>
                    ...
                    <div className="row mb-3">
                      ...
                      <div className="col-8">
                        <div className="range">
                          <MDBRange
                            name={sName("fontweight")}
                            defaultValue={sValue("fontweight")}
                            onChange={handleChange}
                            type="range"
                            className="form-range"
                            min="300"
                    ...
                    <div className="row mb-3">
                      ...
                      <div className="col-8">
                        ...
                        >
                          <input
                            value={sValue("texthighlightcolor")}
                            className="form-control rounded"
                            type="text"
                            disabled
                          />
